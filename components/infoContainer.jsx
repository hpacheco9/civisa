    ...
    <View style={[styles.container, { backgroundColor: containerBackgroundColor }]}>
      <View style={styles.info}>
        <View style={{ flexDirection: 'row', marginBottom: '3%' }}>
          <Image
            source={iswhite ? require('../assets/cal_white.png') : require('../assets/cal.png')}
            style={{ width: 15, height: 15, marginRight: '3%' }}
          />
          <Text style={{ fontWeight: 'bold', color: textColor }}>{date}</Text>
          <Image
            source={iswhite ? require('../assets/clock_white.png') : require('../assets/clock.png')}
            style={{ width: 15, height: 15, marginRight: '3%', marginLeft: '5%' }}
          />
          <Text style={{ fontWeight: 'bold', color: textColor }}>UTC {time}</Text>
        </View>

        <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: '3%' }} >
          <Image
            source={iswhite ? require('../assets/marker_white.png') : require('../assets/marker.png')}
            style={{ width: 15, height: 15, marginRight: '3%' }}
          />
        ...
        {cords && (
          <View style={{ flexDirection: 'row', alignItems: 'center', marginBottom: '3%' }}>
            <Text style={{ color: textColor }}>{`${latitude} N ${longitude} W`}</Text>
          </View>
        )}
        <View style={{ flexDirection: 'row' }}>
          ...
          <Text style={{ color: textColor }}>{intensidade === 'Não sentido' ? '' : intensidade}</Text>
        </View>
      </View>
